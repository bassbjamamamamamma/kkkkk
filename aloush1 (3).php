...
// تم تطوير ملف بوت ارقام من قبل مستر اكس
//@RIYI_1+@RIYI_1قناتي
...
mkdir('data/txt');
mkdir('data/api');
$API_KEY= '7319882701:AAEzYeiKuVA8AUTVqiNjVlDPhfPAjB8Al8Q';//توكن بوتك
...
$chall = "PRONAMERO_1";
$useradmin = "R_IYI1";
$sim =-1002044903636; #القناة الرسمية
$sim =-1002077191052; #قناه التفعيلات
$PAY =-1001861610071; #الارقام المكتملة
$ess =-1002106329144; #عمليات شراء الارقام
$eer =-1002091050038; #اشعارات الايميلات وتحويل الروبل
if($chat_id==7062456406){
$sudo=$chat_id;
}elseif($chat_id==7062456406){
$sudo=$chat_id;
}else{
$sudo==7062456406;
}
...
- عذرا عزيزي... يجب الإشتراك في قنوات البوت الرسمية حتى تتمكن من إستخدام البوت...🙋‍♂ 
إشترك هنا ⏬⏬ ثم إضغط /start 👉

Sorry, dear... You must subscribe to the official bot channels in order to be able to use the bot...🙋‍♂ 
Subscribe here ⏬⏬ then press /start 👉

*- ★ رابط قناة البوت الرسميه: @PRONAMERO*
*- ★ رابط قناة التفعيلات: @PRONAMERO_1*
...
*- في بوت 𓆩•|ــــــــــ(PRO MAX)ـــــــــ|•𓆪 ؛* ؛ البوت الأفضل على التليجرام والذي يقوم بتوفير *خدمات الأرقام الوهمية* ل مواقع السوشيال ميديا مثل *التيليجرام والواتساب والتويتر وغيره* 👾
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'•إنشاء حساب💡•','callback_data'=>"sign_in"],['text'=>'•✅تسجيل دخول✔️•','callback_data'=>"login"]],
[['text'=>'•📜شروط الإستخدام🔗 •','callback_data'=>"to_explain"]],
[['text'=>'•🚦تعليمات البوت🔆 •','callback_data'=>"Important"],
['text'=>'•📈الاحصائيات 🗞• ','callback_data'=>'statsbot2']],
[['text'=>'• 🔴إدارة البوت 📯•🏻‍💻','url'=>"https://t.me/R_IYI1"]]
]
])
]);
...
- لفحص الرقم, أضغط على زر *رؤية الرقم في واتسأب* بعد شراء الرقم, سيقوم بتوجيهك إلى الواتساب, في حالة قال لك *إن رقم الهاتف هذا +967••• ليس في واتسأب* هذا يعني أن الرقم جديد ولم يستخدم في واتسأب من قبل, *أما في الحالات الأخرى فهذا يعني أن الرقم مستخدم في واتسأب ولا نتحمل مسؤولية تفعيلة في أي حال من الأحوال.*
...
'text'=>"
👨‍✈️ *⁞ مرحبا بك* [$first](tg://user?id=$id) ؛
🏛 *⁞ هذه تفاصيل حسابك في بوت. المتميز برو ماكس* ⬇️
...
― 💚[القناة الرسمية](https://t.me/PRONAMERO)❤
― ❤[قناه التفعيلات](https://t.me/PRONAMERO_1)❤
",
'parse_mode'=>"MarkDown",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'✥ شراء رقم  💎٭','callback_data'=>'Buynum']],
[['text'=>'✥ أشحن رصيدك 🎳٭','callback_data'=>'Payment'],['text'=>'✥ قسم الرشق 🚀🏆٭','callback_data'=>'sh']],
[['text'=>'✥ حسابي 👑٭','callback_data'=>"Record"],['text'=>'✥ عروض الوتس اب 🎯٭','callback_data'=>"Wo"]],
[['text'=>'✥العــشــوائــي ✨٭','callback_data'=>"worldwide"],['text'=>'✥قسم المتميز⚡٭','callback_data'=>"saavmotamy"]],
[['text'=>'✥ ربح الروبل مجاناً 💎٭','callback_data'=>"assignment"]],
[['text'=>'✥ متجر الكروت 🪗٭','callback_data'=>"readycard-10"],['text'=>'✥ الارقام الجاهزه⚡٭','callback_data'=>'ready']],
[['text'=>'✥ الوكلاء 🎲٭','callback_data'=>"gents"],['text'=>'✥الاعدادات ⚙٭','callback_data'=>"MyAccount"]],
[['text'=>'✥ المسـاعـدة 💡٭','callback_data'=>"super"]]
]
])
]);
...
'text'=>"
👨‍✈️ *⁞ مرحبا بك* [$first](tg://user?id=$id) ؛
🏛 *⁞ هذه تفاصيل حسابك في بوت. المتميز برو* ⬇️
...
☑️ *⁞ قناة البوت الرسمية: @$chall
🎬︙قم بالتحكم بالبوت الأن عبر الضعط على الأزرار.*
― 💚[القناة الرسمية](https://t.me/bscbshgg124)❤
― ❤[قناه التفعيلات](https://t.me/vshgsccs545)❤
",
'parse_mode'=>"MarkDown",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
...
#=========={الحماية}==========#// تم تطوير ملف بوت ارقام من قبل مستر اكس
//@O_1_W+@AX_GBقناتي
...
*- في  بوت المتميز برو* ؛ البوت الأفضل على التليجرام والذي يقوم بتوفير *خدمات الأرقام الوهمية* ل مواقع السوشيال ميديا مثل *التيليجرام والواتساب والتويتر وغيره* 👾
...
🥇 - [إضغط هنا](t.me/$chall/9) لرؤية *أسعار الشحن* 💰

🎬 - للشحن تواصل مع *الوكيل الرسمي للبوت* ✅
👨‍💻 فريق دعم المتميز برو : *@$useradmin*
",
'parse_mode'=>"MarkDown",
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>'💭 - تواصل بـ فريق دعم المتميز برو ↖️','url'=>"https://t.me/R_IYI1"]],
...
[['text'=>'•🚦تعليمات البوت🔆 •','callback_data'=>"Important"],
['text'=>'•📈الاحصائيات 🗞• ','callback_data'=>'statsbot2']],
[['text'=>'• 🔴إدارة البوت 📯•🏻‍💻','url'=>"http://t.me/vbhfvvbh"]]
]
])
]);
unlink("data/id/$id/step.txt");
...
❤ - [التعليمات لسلامة الرقم✅](https://t.me/PRONAMERO_4)
",
'parse_mode'=>"MarkDown",
'reply_to_message_id'=>$message_id,
]);
...
'message_id'=>$message_id,
'text'=>"
🧑‍✈️ *- أهلا بك عزيزي العميل* في قسم وكلاء البوت الرسميين في بوت *المتميز برو* ☑️
",
'parse_mode'=>"MarkDown",
'reply_markup'=>($keyboad),
]);
